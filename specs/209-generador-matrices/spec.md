# SPEC-209 — Generador de Matrices EIA
...
|---|---|
| **Portal** | Ambiental |
| **Route** | `/[portal]/herramientas/209-generador-matrices` |
| **Primary persona** | Profesional Ambiental |
| **Secondary persona** |  |

**Description**: Genera matrices de evaluación de impacto ambiental exportables a CSV/PDF. Usa @ia-next/matriz-generator.
...
- README: see `apps/web/src/app/(portals)/[portal]/(marketing)/herramientas/209-generador-matrices/README.md`
- ADRs: no specific ADR yet — add one when a significant architectural decision is made for this tool.

---

*Stub — SPEC-209 | Promote to full spec when changes are planned.*
