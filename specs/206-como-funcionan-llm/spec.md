...
|---|---|
| **Portal** | IA |
| **Route** | `/[portal]/herramientas/206-como-funcionan-llm` |
| **Primary persona** | Estudiante Universitario |
| **Secondary persona** | Explorador de IA |

**Description**: Diagrama interactivo de la arquitectura Transformer (tokenización, atención, generación).
...
- README: see `apps/web/src/app/(portals)/[portal]/(marketing)/herramientas/206-como-funcionan-llm/README.md`
- ADRs: no specific ADR yet — add one when a significant architectural decision is made for this tool.

---

*Stub — SPEC-206 | Promote to full spec when changes are planned.*
