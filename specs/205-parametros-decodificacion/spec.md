# SPEC-205 — Parámetros de Decodificación
...
|---|---|
| **Portal** | IA |
| **Route** | `/[portal]/herramientas/205-parametros-decodificacion` |
| **Primary persona** | Estudiante Universitario |
| **Secondary persona** | Explorador de IA |

**Description**: Playground interactivo para experimentar con temperatura, Top-P y Top-K en generación de texto.
...
- README: see `apps/web/src/app/(portals)/[portal]/(marketing)/herramientas/205-parametros-decodificacion/README.md`
- ADRs: no specific ADR yet — add one when a significant architectural decision is made for this tool.

---

*Stub — SPEC-205 | Promote to full spec when changes are planned.*
