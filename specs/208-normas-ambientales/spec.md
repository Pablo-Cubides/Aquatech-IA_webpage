...
|---|---|
| **Portal** | Ambiental |
| **Route** | `/[portal]/herramientas/208-normas-ambientales` |
| **Primary persona** | Profesional Ambiental |
| **Secondary persona** |  |

**Description**: Buscador y navegador de normativa ambiental colombiana (decretos, resoluciones, leyes).
...
- README: see `apps/web/src/app/(portals)/[portal]/(marketing)/herramientas/208-normas-ambientales/README.md`
- ADRs: no specific ADR yet — add one when a significant architectural decision is made for this tool.

---

*Stub — SPEC-208 | Promote to full spec when changes are planned.*
