...
|---|---|
| **Portal** | IA / Autor |
| **Route** | `/[portal]/herramientas/200-aula-score` |
| **Primary persona** | Instructor (Pablo) |
| **Secondary persona** | Estudiante Universitario |

**Description**: Scoreboard de evaluación para instructores. Muestra puntajes de estudiantes en tiempo real por aula.
...
- README: see `apps/web/src/app/(portals)/[portal]/(marketing)/herramientas/200-aula-score/README.md`
- ADRs: no specific ADR yet — add one when a significant architectural decision is made for this tool.

---

*Stub — SPEC-200 | Promote to full spec when changes are planned.*
