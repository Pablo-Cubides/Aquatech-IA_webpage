...
|---|---|
| **Portal** | Ambiental |
| **Route** | `/[portal]/herramientas/207-visor-mapas-ambientales` |
| **Primary persona** | Profesional Ambiental |
| **Secondary persona** |  |

**Description**: Mapa interactivo con capas ambientales (GBIF, WQP, cuencas hidrográficas). Basado en MapLibre GL.
...
- README: see `apps/web/src/app/(portals)/[portal]/(marketing)/herramientas/207-visor-mapas-ambientales/README.md`
- ADRs: no specific ADR yet — add one when a significant architectural decision is made for this tool.

---

*Stub — SPEC-207 | Promote to full spec when changes are planned.*
