...
|---|---|
| **Portal** | IA |
| **Route** | `/[portal]/herramientas/203-visor-difusion` |
| **Primary persona** | Explorador de IA |
| **Secondary persona** | Estudiante Universitario |

**Description**: Visualizador interactivo del proceso de difusión en modelos generativos (Stable Diffusion).
...
- README: see `apps/web/src/app/(portals)/[portal]/(marketing)/herramientas/203-visor-difusion/README.md`
- ADRs: no specific ADR yet — add one when a significant architectural decision is made for this tool.

---

*Stub — SPEC-203 | Promote to full spec when changes are planned.*
