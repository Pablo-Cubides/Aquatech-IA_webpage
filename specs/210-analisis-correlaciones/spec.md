# SPEC-210 — Análisis de Correlaciones
...
|---|---|
| **Portal** | Ambiental |
| **Route** | `/[portal]/herramientas/210-analisis-correlaciones` |
| **Primary persona** | Profesional Ambiental |
| **Secondary persona** |  |

**Description**: Análisis estadístico de correlación entre parámetros ambientales con visualización Recharts.
...
- README: see `apps/web/src/app/(portals)/[portal]/(marketing)/herramientas/210-analisis-correlaciones/README.md`
- ADRs: no specific ADR yet — add one when a significant architectural decision is made for this tool.

---

*Stub — SPEC-210 | Promote to full spec when changes are planned.*
