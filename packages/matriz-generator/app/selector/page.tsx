  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <Link href="/builder/vias/leopold" className="bg-blue-50 hover:bg-blue-100 rounded-lg p-6 text-center transition-colors">
        ...
        <Link href="/builder/vias/conesa" className="bg-green-50 hover:bg-green-100 rounded-lg p-6 text-center transition-colors">
        ...
        <Link href="/builder/vias/battelle" className="bg-purple-50 hover:bg-purple-100 rounded-lg p-6 text-center transition-colors">
