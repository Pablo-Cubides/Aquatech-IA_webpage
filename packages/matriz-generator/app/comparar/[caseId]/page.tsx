...
const sampleCases = [
  {
    ...
    descripcion: "Construcción de tramo vial",
    matrices: ["leopold", "conesa", "battelle"],
  },
  {
    id: "mineria",
    sector: "Minería",
    nombre: "Mina a Rajo Abierto",
    descripcion: "Proyecto minero",
    matrices: ["battelle", "leopold", "conesa"],
  },
];
      ...
      <div className="mb-8">
        ...
        <div className="bg-blue-50 rounded-lg p-4 mb-6">
          ...
          <p className="text-sm text-blue-800">
            Análisis simultáneo de los mismos impactos evaluados con las tres
            metodologías principales. Observa cómo cada método prioriza
            diferentes aspectos y criterios de evaluación.
          </p>
        </div>
      </div>
        ...
        <div className="bg-white border-2 border-yellow-200 rounded-lg">
          <div className="bg-yellow-100 px-6 py-4 border-b border-yellow-200">
            ...
            <p className="text-sm text-yellow-700">
              Enfoque: Valoración multicriterio (10 atributos)
            </p>
          </div>
          <div className="p-6">
        ...
        <div className="bg-white border-2 border-blue-200 rounded-lg">
          <div className="bg-blue-100 px-6 py-4 border-b border-blue-200">
            ...
            <p className="text-sm text-blue-700">
              Enfoque: Unidades de Impacto (UIA)
            </p>
          </div>
          <div className="p-6">
      ...
      <div className="mt-8 bg-gray-50 rounded-lg p-6">
        ...
        <div className="mt-6 bg-blue-100 rounded p-4">
          ...
          <div className="text-sm text-blue-800">
            <strong>{caso.nombre}:</strong> Para este tipo de proyecto se
            recomienda usar
            <strong> {caso.matrices[0]} como método principal</strong> ya que se
            ajusta mejor a las características del sector {caso.sector}. Las
            otras matrices pueden usarse como métodos complementarios para
            validar resultados.
          </div>
        </div>
      </div>
