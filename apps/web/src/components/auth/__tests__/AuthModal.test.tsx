...
describe('AuthModal', () => {
  ...
  describe('Unauthenticated state', () => {
    ...
    it('should show description text', () => {
      ...
      expect(
        screen.getByText(/Inicia sesión para acceder a todas las funcionalidades/)
      ).toBeInTheDocument()
    })
    ...
    it('should show loading state during sign-in', async () => {
      ...
      const loadingButton = screen.getByText('Iniciando sesión...').closest('button')
  ...
  describe('Theme variations', () => {
    it('should apply dark theme text colors', () => {
      ...
      expect(container.querySelector('.text-\\[\\#F3F6FF\\]')).toBeInTheDocument()
      expect(container.querySelector('.text-\\[\\#B6C2DF\\]')).toBeInTheDocument()
    })
    ...
    it('should apply light theme text colors', () => {
      ...
      expect(container.querySelector('.text-\\[\\#0D161C\\]')).toBeInTheDocument()
