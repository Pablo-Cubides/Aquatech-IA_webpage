...
describe("filterItems", () => {
  ...
  describe("Level filtering", () => {
    it("should filter courses by intro level", () => {
      ...
      expect(
        result.every((r) => r.level === "intro" || r.type !== "course"),
      ).toBe(true);
    });
    ...
    it("should filter by advanced level", () => {
      ...
      const advancedItems = result.filter(
        (r) => r.type === "course" || r.type === "certification",
      );
  ...
  describe("Price filtering", () => {
    ...
    it("should filter items under $25", () => {
      ...
      expect(result.every((r) => r.price && r.price > 0 && r.price < 25)).toBe(
        true,
      );
    });
    ...
    it("should filter items $25-$100", () => {
      ...
      expect(
        result.every((r) => r.price && r.price >= 25 && r.price <= 100),
      ).toBe(true);
    });
    ...
    it("should filter items $100-$300", () => {
      ...
      expect(
        result.every((r) => r.price && r.price > 100 && r.price <= 300),
      ).toBe(true);
    });
  ...
  describe("Combined filters", () => {
    it("should apply multiple filters correctly", () => {
      ...
      expect(
        result.every(
          (r) =>
            r.type === "course" && r.language === "es" && r.level === "intro",
        ),
      ).toBe(true);
    });
    ...
    it("should handle search with filters", () => {
      ...
      expect(result.length).toBeGreaterThan(0);
      expect(
        result.every((r) => r.type === "course" && r.language === "es"),
      ).toBe(true);
    });
