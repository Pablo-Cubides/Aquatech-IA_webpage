  ...
  const questions = [
    {
      ...
      options: [
        { text: "Simple (infraestructura básica, pocos impactos)", recommendation: "leopold" },
        { text: "Moderado (múltiples componentes, impactos diversos)", recommendation: "conesa" },
        { text: "Complejo (gran escala, múltiples fases)", recommendation: "battelle" },
      ],
    },
  ];
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="text-center">
        ...
        <p className="text-lg text-gray-700">Responde estas preguntas para encontrar la matriz más adecuada para tu proyecto</p>
      </div>
          ...
          {questions.map((q, index) => (
            <div key={q.id} className="border-b pb-6 last:border-b-0">
              <h3 className="text-xl font-semibold mb-4 flex items-center">
                <span className="bg-primary text-white w-8 h-8 rounded-full flex items-center justify-center text-sm mr-3">{index + 1}</span>
                {q.question}
              </h3>
                ...
                {q.options.map((option, optIndex) => (
                  <div key={optIndex} className="border rounded-lg p-4 hover:bg-gray-50 cursor-pointer transition-colors">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-sm bg-gray-100 px-3 py-1 rounded-full">→ {option.recommendation}</span>
                    </div>
                  </div>
                ))}
              </div>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <Link href="/ambiental/herramientas/generador-matrices/app/builder/vias/leopold" className="bg-blue-50 hover:bg-blue-100 rounded-lg p-6 text-center transition-colors">
        ...
        <Link href="/ambiental/herramientas/generador-matrices/app/builder/vias/conesa" className="bg-green-50 hover:bg-green-100 rounded-lg p-6 text-center transition-colors">
        ...
        <Link href="/ambiental/herramientas/generador-matrices/app/builder/vias/battelle" className="bg-purple-50 hover:bg-purple-100 rounded-lg p-6 text-center transition-colors">
