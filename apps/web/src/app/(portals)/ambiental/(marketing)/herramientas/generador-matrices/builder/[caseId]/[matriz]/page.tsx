...
export default function Builder({
  ...
  const loadCaseData = (caseId: string) => {
    const caseData: Record<string, any> = {
      ...
      hidroelectrica: {
        acciones: [
          { id: "a1", fase: "preoperativa", nombre: "Construcción de presa" },
          { id: "a2", fase: "preoperativa", nombre: "Desvío de río" },
          { id: "a3", fase: "operativa", nombre: "Llenado de embalse" },
          { id: "a4", fase: "operativa", nombre: "Generación eléctrica" },
        ...
        factores: [
          ...
          },
          {
            id: "f3",
            medio: "biotico",
            nombre: "Fauna acuática",
            sensibilidad: "alta",
          },
          {
            id: "f4",
            medio: "biotico",
            nombre: "Ecosistemas ribereños",
            sensibilidad: "alta",
          },
          {
            id: "f5",
    ...
    data.acciones.forEach((accion: Action) => {
      data.factores.forEach((factor: Factor) => {
        if (
          ...
          (accion.nombre.toLowerCase().includes("construcción") &&
            factor.medio === "fisico") ||
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div>• Comparar con otras metodologías</div>
                </div>
