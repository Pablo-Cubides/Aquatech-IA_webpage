...
const matrixInfo: Record<string, { title: string; description: string }> = {
  leopold: {
    ...
    description:
      "La matriz clásica de EIA desarrollada en 1971. Utiliza magnitud (-10 a +10) e importancia (1 a 10) para evaluar impactos ambientales de forma rápida y visual.",
  },
  conesa: {
    title: "Matriz de Conesa",
    description:
      "Metodología española multicriterio con 10 atributos. Evalúa intensidad, extensión, momento, persistencia y más para clasificar impactos como irrelevantes, moderados, severos o críticos.",
  },
  battelle: {
    title: "Sistema Battelle-Columbus",
    description:
      "Sistema cuantitativo que usa Unidades de Importancia (UIP) y calidad ambiental (1-4) para análisis económico-ambiental detallado de proyectos.",
  },
};

export async function generateMetadata({
  params,
}: MatrixDetailProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: `${info.title} - Generador de Matrices EIA`,
      description: info.description,
    },
  };
}
...
export default async function MatrixDetailPage({
  ...
  const matrixData: Record<string, any> = {
    leopold: {
      title: "Matriz de Leopold",
      description:
        "La matriz de Leopold es una herramienta clásica de evaluación de impacto ambiental desarrollada en 1971 por Luna Leopold y sus colaboradores del Servicio Geológico de EE.UU. (USGS).",
      formula: "Significancia (S) = |Magnitud| × Importancia",
      references: [
        {
          title: "Publicación original USGS (1971)",
          url: "https://pubs.usgs.gov/circ/1971/0645/report.pdf",
        },
        {
          title: "Guía práctica matriz Leopold",
          url: "https://www.isotools.us/2023/07/20/matriz-leopold-de-causa-y-efecto-para-los-impactos-ambientales/",
        },
        {
          title: "Análisis de causa y efecto",
          url: "https://www.ecoembesthecircularcampus.com/matriz-de-leopold/",
        },
      ],
      explanation: {
        magnitud:
          "Grado de alteración que produce la acción sobre el factor. Escala de -10 a +10 con signo (+ beneficioso, - perjudicial).",
        importancia:
          "Peso relativo del factor en el conjunto del medio ambiente. Escala de 1 a 10 (1 = poca importancia, 10 = muy importante).",
        significancia:
          "Resultado final que combina magnitud e importancia. Permite priorizar impactos.",
      },
      steps: [
    ...
    conesa: {
      title: "Matriz de Conesa",
      description:
        "Metodología española desarrollada por Vicente Conesa Fernández-Vítora que utiliza evaluación multicriterio con 10 atributos para mayor objetividad en la valoración de impactos.",
      formula: "I = 3×IN + 2×EX + MO + PE + RV + SI + AC + EF + PR + MC",
      references: [
        {
          title: "Métodos de Evaluación de Impacto Ambiental",
          url: "https://www.researchgate.net/publication/280557688_Metodos_de_Evaluacion_de_Impacto_Ambiental_en_Colombia",
        },
        {
          title: "Metodología Conesa aplicada",
          url: "https://www.slideshare.net/slideshow/metodologia-conesa-paralaevalucionde/93381305",
        },
        {
          title: "Guía técnica de evaluación (IDB)",
          url: "https://idbinvest.org/sites/default/files/2022-04/PAGA%20UF0%20CAP%2004%20-%20EVALUACI%C3%93N%20IMPACTOS.pdf",
        },
      ],
      explanation: {
        criteria:
        ...
        calculation:
          "Cada criterio se evalúa en escalas específicas y se pondera según la fórmula",
        categories:
          "Irrelevante (<25), Moderado (25-49), Severo (50-74), Crítico (≥75)",
      },
      steps: [
      ...
      advantages: [
        ...
        "Ampliamente aceptada en España y Latinoamérica",
    ...
    battelle: {
      title: "Sistema Battelle-Columbus",
      description:
        "Sistema cuantitativo desarrollado por el Instituto Battelle-Columbus para evaluación objetiva mediante parámetros ambientales con Unidades de Impacto Ambiental (UIA).",
      formula: "UIA = UIP × (Calidad_con_proyecto - Calidad_sin_proyecto)",
      references: [
        {
          title: "Sistema de Evaluación Ambiental Battelle",
          url: "https://uon.sdsu.edu/el_sea_de_battelle.html",
        },
        {
          title: "EIA Methodology - Battelle Approach",
          url: "https://ebooks.inflibnet.ac.in/esp12/chapter/eia-methodology/",
        },
        {
          title: "The Battelle Environmental Evaluation System",
          url: "https://uon.sdsu.edu/the_battelle_ees.html",
        },
      ],
      explanation: {
        uip: "Unidades de Importancia del Parámetro: peso relativo (1-1000)",
        quality: "Calidad ambiental: valor de 1 a 4 (1 = muy mala, 4 = buena)",
      ...
      steps: [
        ...
        "Evaluar calidad sin proyecto (1-4)",
        "Evaluar calidad con proyecto (1-4)",
        "Calcular PIA = UIP × Calidad para cada escenario",
        "Calcular UIA = PIA_con - PIA_sin",
    ...
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="bg-white rounded-lg shadow p-8">
        ...
        <div className="grid gap-4">
          {matrix.steps.map((step: string, index: number) => (
            <div
              key={index}
              className="flex items-start border-l-4 border-blue-600 pl-4 py-2"
            >
              <span className="bg-blue-600 text-white w-8 h-8 rounded-full flex items-center justify-center text-sm mr-4 flex-shrink-0">
                {index + 1}
              </span>
      ...
      {matrix.references && matrix.references.length > 0 && (
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6">
          ...
          <p className="text-sm text-gray-600 mb-4">
            Consulta estas fuentes académicas y técnicas para profundizar en la
            metodología:
          </p>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-green-600 text-white rounded-lg p-8 text-center">
        <h2 className="text-2xl font-bold mb-4">
          ¿Listo para aplicar {matrix.title}?
        </h2>
        <p className="text-lg mb-6">
          Elige un caso de estudio para construir tu matriz paso a paso
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href={`../builder/vias/${type}`}
          ...
          <Link
            href="../faq"
            className="inline-block bg-transparent border-2 border-white text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-white hover:text-blue-600 transition-colors"
          >
            ¿Dudas? Ver FAQ
          </Link>
        </div>
