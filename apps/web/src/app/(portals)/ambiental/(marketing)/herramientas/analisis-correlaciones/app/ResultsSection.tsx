...
export default function ResultsSection({ result }: { result: any }) {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <ExportButtons correlationResults={result.correlation_results} numericColumns={result.numeric_columns} rawData={result.raw_data} heatmapRef={heatmapRef as React.RefObject<HTMLDivElement> | undefined} />
      <CorrelationTable
