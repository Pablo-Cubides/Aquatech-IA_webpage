        ...
        <CardHeader className="pb-3">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <CardTitle className="text-base line-clamp-2 group-hover:text-blue-700">
                {sector.nombre}
              </CardTitle>
            ...
            <div className="mb-16">
              <div className="mb-10 text-center">
                ...
                <p className="max-w-2xl mx-auto text-lg text-gray-600">
                  Selecciona el área temática que deseas explorar y descubre los
                ...
                {DOMINIOS.map((dominio) => (
                  ...
                  >
                    <div className="flex flex-col items-center gap-3">
                      <div
                        className={`text-4xl transition-transform group-hover:scale-110 ${selectedDomain === dominio.id ? "scale-110" : ""}`}
                      >
                        {dominio.icon}
                      </div>
                      <div
                        className={`font-bold text-sm text-center ${selectedDomain === dominio.id ? "text-white" : "text-gray-900"}`}
                      >
                        {dominio.label}
                      </div>
                      <div
                        className={`text-xs text-center line-clamp-2 ${selectedDomain === dominio.id ? "text-blue-100" : "text-gray-600"}`}
                      >
                        {dominio.description}
                      </div>
                    </div>
            ...
            {selectedDomain && (
              <div className="mb-16 animate-in fade-in slide-in-from-top-4">
                <div className="mb-10 text-center">
                  ...
                  <p className="max-w-2xl mx-auto text-lg text-gray-600">
                    Selecciona el país para ver los estándares disponibles en el
                    dominio de {currentDominio?.label.toLowerCase()}
                  </p>
                </div>
              ...
              (selectedDomain === "agua" ||
                ...
                <div className="mb-16 animate-in fade-in slide-in-from-top-4">
                  <div className="mb-10 text-center">
                    ...
                    <h2 className="mb-3 text-3xl font-bold text-gray-900 md:text-4xl">
                      {selectedDomain === "agua"
                        ? "Elige un Sector de Uso"
                        : "Elige un Sector Industrial"}
                    </h2>
                    <p className="max-w-2xl mx-auto text-lg text-gray-600">
                      {currentDominio?.label} •{" "}
                      {
                        domainCountries.find((c) => c.code === selectedCountry)
                          ?.name
                      }
                    </p>
                  </div>
                  {isLoadingSectors ? (
                    <div className="py-12 text-center">
                      <div className="inline-block mb-3 text-4xl animate-spin">
                        ⏳
                      </div>
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-3">
                      {availableSectors.map((sectorId) => {
                        ...
                        const sectorInfo = WATER_USE_SECTORS.find(
                          (s) => s.id === sectorIdStr,
                        ) || {
                          id: sectorIdStr,
                          nombre: sectorIdStr
                    ...
                    <Card className="border-0 shadow-md bg-yellow-50">
                      <CardContent className="p-8 text-center">
                        ...
                        <p className="font-medium text-gray-700">
                          No hay sectores disponibles para este país en este
                          dominio.
                        </p>
                      </CardContent>
                    </Card>
                ...
                <div className="mb-16 animate-in fade-in slide-in-from-top-4">
                  ...
                  <div className="flex justify-center">
                    ...
                    >
                      <Button
                        size="lg"
                        className="px-8 py-6 text-lg shadow-lg bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800"
                      >
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="mb-2 text-lg font-bold text-gray-900">
                      ¿Necesitas ayuda para entender la normativa?
                    </h3>
                    <p className="mb-4 text-gray-700">
                      Aprende los conceptos básicos sobre normatividad ambiental
                      internacional y cómo interpretar correctamente los
