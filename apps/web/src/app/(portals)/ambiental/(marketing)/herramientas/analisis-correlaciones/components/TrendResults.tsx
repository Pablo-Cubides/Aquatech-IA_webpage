        ...
        return (
          ...
          >
            <div className="flex justify-between items-start mb-4 border-b pb-2">
              ...
              <span
                className={`px-3 py-1 rounded-full text-sm font-bold bg-gray-100 ${trendColor}`}
              >
                {trendIcon} Tendencia{" "}
                {data.trend === "increasing"
                  ? "Creciente"
            ...
            <p className="text-xs text-gray-400 italic">
              * Proyección basada en regresión lineal simple sobre los datos
