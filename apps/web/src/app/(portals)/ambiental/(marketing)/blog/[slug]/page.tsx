...
export async function generateMetadata({
  ...
  const article = await getArticle("ambiental", slug);
          ...
          <aside className="lg:col-span-4 lg:sticky top-24 self-start space-y-8">
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-200">
              <div className="relative">
                <input
                  type="text"
                  aria-label="Buscar artículos en el blog ambiental"
            ...
            <div className="bg-gradient-to-br from-[#10B981] to-[#059669] p-6 rounded-xl shadow-lg text-[#10111A]">
              ...
              <form className="space-y-3">
                <input
                  type="email"
                  aria-label="Tu correo electrónico para suscribirte al boletín de sostenibilidad"
