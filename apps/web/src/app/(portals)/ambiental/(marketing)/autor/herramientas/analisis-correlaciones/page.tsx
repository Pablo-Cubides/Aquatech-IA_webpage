...
export default function AnalisisCorrelacionesAmbientalPage() {
  return (
    <div
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-3 mb-6">
              <div className="w-16 h-16 rounded-lg bg-gradient-to-r from-[var(--accent-teal)] to-[var(--primary-green)] flex items-center justify-center">
            ...
            <p className="text-lg text-[var(--text-secondary)] max-w-2xl mx-auto">
              ...
              datos hidrológicos y parámetros de calidad del agua.
            </p>
          </div>
          ...
          <div className="container-app mb-12">
            <div className="app-content">
              <div className="text-center py-20">
                <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-gradient-to-r from-[var(--accent-teal)] to-[var(--primary-green)] flex items-center justify-center">
                ...
                <p className="text-[var(--text-secondary)] mb-8 max-w-md mx-auto">
                  ...
                  analizar correlaciones entre variables ambientales.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <button className="px-6 py-3 bg-gradient-to-r from-[var(--accent-teal)] to-[var(--primary-green)] text-white font-semibold rounded-lg hover:opacity-90 transition-opacity">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <p className="text-[var(--text-secondary)] text-sm">
                Gráficos de dispersión, matrices de correlación y mapas de calor
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-[var(--text-secondary)] text-sm">
                Coeficientes de correlación, regresiones y análisis de
                tendencias
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-[var(--text-secondary)] text-sm">
                Sube tus archivos CSV, Excel o conecta con bases de datos
              </p>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-2xl p-8 border border-[var(--border-color)]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Link
                ...
                className="flex items-center gap-4 p-4 rounded-lg border border-[var(--border-color)] bg-white hover:border-[var(--accent-blue)] transition-colors group"
              >
                <div className="w-10 h-10 rounded-lg bg-gradient-to-r from-[var(--accent-blue)] to-[var(--accent-teal)] flex items-center justify-center">
                  <RotateCcw className="w-5 h-5 text-white" />
                </div>
                <div>
                  <h4 className="font-semibold group-hover:text-[var(--accent-blue)]">
                    Ruleta de Preguntas
                  </h4>
                  <p className="text-sm text-[var(--text-secondary)]">
