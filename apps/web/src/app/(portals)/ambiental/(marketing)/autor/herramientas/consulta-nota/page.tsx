...
export default function ConsultaNotaAmbientalPage() {
  return (
    <div
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-3 mb-6">
              <div className="w-16 h-16 rounded-lg bg-gradient-to-r from-[var(--primary-green)] to-[var(--accent-blue)] flex items-center justify-center">
            ...
            <p className="text-lg text-[var(--text-secondary)] max-w-2xl mx-auto">
              ...
              productos ambientales y ciencias del agua de manera rápida y
              organizada.
            </p>
          </div>
          ...
          <div className="container-app mb-12">
            <div className="app-content">
              <div className="text-center py-20">
                <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-gradient-to-r from-[var(--primary-green)] to-[var(--accent-blue)] flex items-center justify-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <button className="px-6 py-3 bg-gradient-to-r from-[var(--primary-green)] to-[var(--accent-blue)] text-white font-semibold rounded-lg hover:opacity-90 transition-opacity">
