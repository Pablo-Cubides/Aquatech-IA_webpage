        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-3 mb-6">
              <div className="w-16 h-16 rounded-lg bg-gradient-to-r from-[var(--accent-purple)] to-[var(--accent-pink)] flex items-center justify-center">
            ...
            <p className="text-lg text-[var(--text-secondary)] max-w-2xl mx-auto">
              ...
              programación para estudiar y practicar tus conocimientos.
            </p>
          </div>
          ...
          <div className="container-app mb-12">
            <div className="app-content">
              <div className="text-center py-20">
                <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-gradient-to-r from-[var(--accent-purple)] to-[var(--accent-pink)] flex items-center justify-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <button className="px-6 py-3 bg-gradient-to-r from-[var(--accent-purple)] to-[var(--accent-pink)] text-white font-semibold rounded-lg hover:opacity-90 transition-opacity">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              ...
              <p className="text-[var(--text-secondary)] text-sm">
                Preguntas sobre LLMs, ML, Deep Learning, programación y más
              </p>
            </div>
            <div className="text-center">
