...
export const metadata: Metadata = {
  ...
  description:
    "Aplicación educativa interactiva para comprender Temperature, Top-k Sampling, Top-p (Nucleus) Sampling y Penalización por Repetición en Modelos de Lenguaje. Aprende cómo estos parámetros afectan la generación de texto en GPT, Claude y otros LLMs.",
  keywords: [
    "modelos de lenguaje",
  ...
  twitter: {
    ...
    description:
      "Experimenta con Temperature, Top-k y Top-p Sampling en tiempo real. Herramienta educativa para entender parámetros de LLMs.",
    images: ["/og-image.png"],
