...
const academicReferences = {
  temperature: [
    {
      title: "Temperature in LLM Sampling",
      url: "https://nlp.stanford.edu/blog/maximum-likelihood-decoding-with-rnns-the-good-the-bad-and-the-ugly/",
      source: "Stanford NLP",
    },
    {
      title: "Temperature Parameter Guide",
      url: "https://cloud.google.com/vertex-ai/generative-ai/docs/learn/prompts/adjust-parameter-values?hl=es-419",
      source: "Google Vertex AI",
    },
    {
      title: "Understanding Temperature",
      url: "https://learnprompting.org/es/docs/basics/configuration_hyperparameters",
      source: "LearnPrompting",
    },
  ],
  topK: [
    {
      title: "Top-K Sampling for Generation",
      url: "https://openreview.net/forum?id=rygGQyrFvH",
      source: "OpenReview",
    },
    {
      title: "Neural Text Generation Paper",
      url: "https://ar5iv.labs.arxiv.org/html/1904.09751",
      source: "arXiv",
    },
    {
      title: "Top-K Glossary",
      url: "https://dataforest.ai/glossary/top-k-sampling",
      source: "DataForest",
    },
  ],
  topP: [
    {
      title: "Nucleus Sampling Paper",
      url: "https://ar5iv.labs.arxiv.org/html/1904.09751",
      source: "arXiv",
    },
  ],
...
export default function Home() {
  ...
  function downloadJSON() {
    const payload = {
      ...
      params: { temperature, topK, topP, repetitionPenalty },
      text: variantText,
    };
  ...
  const academic: Academic = useMemo(
    () => ({
      temperatura: {
        summary:
          "Controla la aleatoriedad del muestreo: valores bajos hacen las predicciones más deterministas; valores altos introducen variedad y creatividad.",
        examples: [
          {
            v: 0.1,
            text: "Salida conservadora: frases muy previsibles y repetibles.",
          },
          { v: 0.7, text: "Equilibrio: respuestas variadas pero coherentes." },
          {
            v: 1.2,
            text: "Muy creativa: alto riesgo de incoherencias, útil para brainstorming.",
          },
        ],
      },
      topk: {
        summary:
          "Limita el número de candidatos considerados por paso a los k tokens más probables; reduce la entropía en cada paso.",
        examples: [
      ...
      topp: {
        summary:
          "Top-p (nucleus sampling) selecciona del conjunto más probable cuya probabilidad acumulada alcanza p; controla núcleo de distribución.",
        examples: [
      ...
      repetition: {
        summary:
          "Penaliza repetir tokens o frases, útil para evitar muletillas y bucles en la generación.",
        examples: [
          { v: 1.0, text: "Sin penalización: puede repetir conceptos." },
          {
            v: 1.3,
            text: "Penalización moderada: reduce repeticiones comunes.",
          },
          {
            v: 1.8,
            text: "Fuerte penalización: fuerza diversidad de palabras aunque puede perder precisión.",
          },
        ],
      },
    }),
    ...
    () =>
      ({
        A: {
          ...
          coherence: "high",
          diversity: "low",
          repetitionControl: "medium",
        },
        B: {
          creativity: "low",
          coherence: "high",
          diversity: "low",
          repetitionControl: "high",
        },
        C: {
          creativity: "medium",
          coherence: "high",
    ...
    <main className="max-w-7xl mx-auto p-8 text-white">
      ...
      <div className="mb-8 stepper sticky top-0 z-40">
        ...
        <div className="ml-4 text-sm text-[#CCCCCC] hidden md:block">
          <span
            className={activeStep === 1 ? "text-[#00efff] font-semibold" : ""}
          >
            📚 Qué es
          </span>
          <span className="mx-2 text-[#666]">•</span>
          <span
            className={activeStep === 2 ? "text-[#0095ff] font-semibold" : ""}
          >
            ⚙️ Parámetros
          </span>
          <span className="mx-2 text-[#666]">•</span>
          <span
            className={activeStep === 3 ? "text-[#10b981] font-semibold" : ""}
          >
            🎮 Playground
          </span>
          <span className="mx-2 text-[#666]">•</span>
          <span
            className={activeStep === 4 ? "text-[#00efff] font-semibold" : ""}
          >
            📖 Referencias
          </span>
        </div>
        ...
        <section className="mb-8 animate-step">
          ...
          <div className="glass-strong rounded-2xl p-6 mb-6 relative overflow-hidden">
            ...
            <p className="text-[#CCCCCC] leading-relaxed relative z-10">
              Esta aplicación es un recurso académico que demuestra, paso a
              paso, cómo los parámetros de decodificación (
              ...
              ) influyen en la generación de texto por un LLM. Primero
              explicamos cada parámetro conceptualmente, luego mostramos
              ejemplos numéricos y, finalmente, permitimos experimentar con
              ejemplos prácticos (playground).
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-8">
            <div className="group glass-strong rounded-xl p-6 border-l-4 border-[#00efff] hover:border-[#00efff] hover:shadow-lg hover:shadow-[#00efff]/20 hover:scale-105 transition-all duration-300">
              ...
              <h3 className="text-lg font-bold text-[#00efff] mb-2">
                Temperatura
              </h3>
              <p className="text-sm text-[#CCCCCC] leading-relaxed">
                Controla la aleatoriedad en el muestreo: valores bajos
                concentran probabilidad en el modo más probable; valores
                intermedios equilibran coherencia y variedad; valores altos
                amplifican la diversidad.
              </p>
            </div>
            <div className="group glass-strong rounded-xl p-6 border-l-4 border-[#0095ff] hover:border-[#0095ff] hover:shadow-lg hover:shadow-[#0095ff]/20 hover:scale-105 transition-all duration-300">
              ...
              <p className="text-sm text-[#CCCCCC] leading-relaxed">
                Limita el número absoluto de candidatos considerados en cada
                paso. Un k pequeño fuerza salidas predecibles, un k grande
                permite mucha diversidad pero puede introducir ruido.
              </p>
            </div>
            <div className="group glass-strong rounded-xl p-6 border-l-4 border-[#10b981] hover:border-[#10b981] hover:shadow-lg hover:shadow-[#10b981]/20 hover:scale-105 transition-all duration-300">
              ...
              <p className="text-sm text-[#CCCCCC] leading-relaxed">
                Selecciona el núcleo probabilístico acumulado hasta alcanzar la
                masa p. A diferencia de top-k, top-p adapta el tamaño del
                conjunto según la distribución.
              </p>
            </div>
            <div className="group glass-strong rounded-xl p-6 border-l-4 border-[#00efff] hover:border-[#00efff] hover:shadow-lg hover:shadow-[#00efff]/20 hover:scale-105 transition-all duration-300">
              <div className="text-3xl mb-3">🔄</div>
              ...
              <p className="text-sm text-[#CCCCCC] leading-relaxed">
                Reduce la probabilidad de volver a escoger tokens ya generados,
                evitando bucles y muletillas; un valor moderado mejora
                diversidad sin sacrificar coherencia.
              </p>
            </div>
          </div>
      ...
      {activeStep === 2 && (
        <section className="mb-8 animate-step">
          <StepHeader
            num={2}
            title="Parámetros — explicación detallada y ejemplos"
          />
          <div className="space-y-6">
            {subStep === 0 && (
              <div className="glass-strong rounded-2xl p-8 animate-scale-in">
                ...
                <p className="text-sm text-[#CCCCCC] mb-6 leading-relaxed">
                  {academic.temperatura.summary} En esta sección profundizamos
                  en cómo la temperatura afecta la distribución de probabilidad
                  y ejemplos prácticos de cuándo ajustar T para tareas
                  específicas (e.g., redacción formal vs brainstorming).
                </p>

                {/* Referencias académicas */}
                <div className="mb-6">
                  <AcademicReferences
                    links={academicReferences.temperature}
                    compact
                  />
                </div>

                <ExampleList
                  examples={academic.temperatura.examples}
                  highlighted={
                    highlighted ? highlighted.replace("temp-", "") : null
                  }
                />
            ...
            {subStep === 1 && (
              <div className="glass-strong rounded-2xl p-8 animate-scale-in">
                ...
                <p className="text-sm text-[#CCCCCC] mb-6 leading-relaxed">
                  {academic.topk.summary} Aquí profundizamos en el trade-off
                  entre control y diversidad al fijar un k fijo, y ejemplos de
                  ajustes para tareas de completado o generación controlada.
                </p>
                ...
                <ExampleList
                  examples={academic.topk.examples}
                  highlighted={
                    highlighted ? highlighted.replace("k-", "") : null
                  }
                />
                <div className="mt-6 flex justify-between">
                  <button
            ...
            {subStep === 2 && (
              <div className="glass-strong rounded-2xl p-8 animate-scale-in">
                ...
                <p className="text-sm text-[#CCCCCC] mb-6 leading-relaxed">
                  {academic.topp.summary} Profundizamos en cómo el núcleo
                  adaptativo evita forzar un tamaño fijo y ejemplos prácticos
                  para diferentes tareas (resumen, diálogo, creatividad).
                </p>
                ...
                <ExampleList
                  examples={academic.topp.examples}
                  highlighted={
                    highlighted ? highlighted.replace("p-", "") : null
                  }
                />
                <div className="mt-6 flex justify-between">
                  <button
            ...
            {subStep === 3 && (
              <div className="glass-strong rounded-2xl p-8 animate-scale-in">
                ...
                <p className="text-sm text-[#CCCCCC] mb-6 leading-relaxed">
                  {academic.repetition.summary} Estrategias para ajustar la
                  penalización y ejemplos sobre cómo evitar repeticiones sin
                  perder coherencia semántica.
                </p>
                <ExampleList
                  examples={academic.repetition.examples}
                  highlighted={
                    highlighted ? highlighted.replace("r-", "") : null
                  }
                />
                <div className="mt-6 flex justify-between">
                  <button
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <aside className="lg:col-span-1 space-y-6">
              ...
              <div className="glass rounded-xl p-5 space-y-6">
                <h3 className="text-sm font-bold text-gradient mb-4">
                ...
                <SliderEnhanced
                  ...
                  onChange={(v) => {
                    setTemperature(v);
                    const idx = nearestIndexForExamples(
                      academic.temperatura.examples,
                      v,
                    );
                    pulseHighlight(`temp-${idx}`);
                  }}
                  id="slider-temp"
                ...
                <SliderEnhanced
                  ...
                  step={1}
                  onChange={(v) => {
                    setTopK(Math.round(v));
                    const idx = nearestIndexForExamples(
                      academic.topk.examples,
                      v,
                    );
                    pulseHighlight(`k-${idx}`);
                  }}
                  id="slider-k"
                ...
                <SliderEnhanced
                  ...
                  onChange={(v) => {
                    setTopP(v);
                    const idx = nearestIndexForExamples(
                      academic.topp.examples,
                      v,
                    );
                    pulseHighlight(`p-${idx}`);
                  }}
                  id="slider-p"
                ...
                <SliderEnhanced
                  ...
                  onChange={(v) => {
                    ...
                    const idx = nearestIndexForExamples(
                      academic.repetition.examples,
                      v,
                    );
                    pulseHighlight(`r-${idx}`);
                  }}
                  id="slider-r"
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="glass-strong rounded-2xl p-8 relative overflow-hidden gradient-border">
                ...
                <div className="relative z-10">
                  <p className="text-xs uppercase tracking-wider text-primary/80 mb-2 font-bold">
                    Caso de ejemplo
                  </p>
                  <p className="text-sm italic text-[#CCCCCC] mb-4">
                    {currentCase.title}...
                  </p>
                  ...
                  <div
                    aria-live="polite"
                    role="status"
                    className="mt-6 text-2xl md:text-3xl leading-relaxed font-medium whitespace-pre-wrap min-h-[10rem]"
                  >
                    {displayed}
                    <span
                      className={`inline-block w-1.5 h-7 ml-1 align-baseline rounded-full ${isTyping ? "bg-gradient-cyber animate-pulse" : "bg-transparent"}`}
                      aria-hidden
                    />
                  </div>
                </div>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                >
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <path
                      d="M14 8c0-3.3-2.7-6-6-6S2 4.7 2 8"
                      stroke="currentColor"
                      strokeWidth="2"
                      strokeLinecap="round"
                    />
              ...
              <div className="glass rounded-xl p-6">
                <h3 className="text-lg font-bold text-gradient mb-3">
                  Interpretación del Patrón {selectedPattern}
                </h3>
      ...
      {activeStep === 4 && (
        <section className="animate-step">
          ...
          <div className="glass-strong rounded-2xl p-8">
            <ul className="space-y-4">
              {[
                ...
                {
                  title:
                    "Fan et al., Strategies for Diverse and Controllable Text Generation — 2018",
                ...
                },
                {
                  ...
                  url: "https://blog.openai.com/better-language-models/",
                },
                {
                  title:
                    "Pahuja et al., On the Role of Sampling Strategies in Text Generation — 2021",
                ...
                <li key={i} className="flex items-start gap-3 group">
                  ...
                  >
                    {ref.title}
                    <svg
                      className="inline-block ml-2 w-4 h-4 opacity-50 group-hover:opacity-100"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
          ...
          <div className="mt-8 flex justify-between">
            <button onClick={() => setActiveStep(3)} className="btn btn-ghost">
              ← Anterior
            </button>
            <button
        ...
        <div className="flex items-center justify-center gap-2 mb-3">
          <div className="w-8 h-8 rounded-lg bg-gradient-cyber flex items-center justify-center">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path
                d="M10 2L12 8L18 9L14 13L15 19L10 15L5 19L6 13L2 9L8 8L10 2Z"
                fill="currentColor"
