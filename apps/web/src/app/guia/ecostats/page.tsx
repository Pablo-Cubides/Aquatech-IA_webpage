...
const Section = ({
  ...
  >
    <div className="flex items-center gap-4 mb-6">
      ...
      <h2 className="text-3xl font-bold text-gray-900 border-b-4 border-cyan-500 pb-2">
        {title}
      </h2>
    </div>
...
const MethodCard = ({
  ...
  <div className="p-6 rounded-2xl border border-gray-100 bg-slate-50 h-full hover:shadow-md transition-all">
    <h4 className="text-xl font-bold mb-3 text-cyan-700">{title}</h4>
    <p className="text-sm text-gray-700 mb-4">{description}</p>
    <div className="text-xs font-semibold bg-white p-3 rounded-lg border border-gray-200 text-gray-600">
      <span className="block mb-1 text-cyan-600 uppercase tracking-wider">
        Cuándo usarlo:
      </span>
      {usage}
    </div>
        ...
        <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <aside className="lg:col-span-1 border-r border-gray-200 pr-8 hidden lg:block h-fit sticky top-24">
            ...
            <nav className="flex flex-col gap-3">
              ...
              <a
                href="#métodos-estadísticos"
                className="text-gray-600 hover:text-cyan-600 font-medium transition-colors"
              >
                📐 Métodos
              </a>
              <a
                href="#prepara-tus-datos"
                className="text-gray-600 hover:text-cyan-600 font-medium transition-colors"
              >
                📊 Tus Datos
              </a>
          ...
          <div className="lg:col-span-3">
            <Section title="Introducción" icon="👋">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">
                Ciencia de Datos para el Medio Ambiente
              </h3>
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                <strong>ECOstats</strong> nace con la misión de democratizar el
                análisis estadístico avanzado. Diseñada para investigadores,
                estudiantes y gestores ambientales, esta herramienta permite
                validar hipótesis complejas sin la barrera de entrada de la
                programación.
              </p>
              <p className="text-gray-600 bg-cyan-50 p-6 rounded-xl border border-cyan-100">
                Ya sea para una <strong>tesis académica</strong>, un{" "}
                <strong>informe técnico</strong> o un{" "}
                <strong>proyecto de monitoreo</strong>, ECOstats te ofrece la
                precisión de R y Python en una interfaz amigable.
              </p>
            </Section>

            <Section title="Fuentes de Datos" icon="🌍">
              <p className="text-gray-700 mb-8">
                La plataforma no solo procesa tus archivos locales, sino que se
                conecta directamente con repositorios globales de prestigio para
                enriquecer tus análisis:
              </p>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="p-6 rounded-2xl border border-blue-100 bg-white hover:shadow-md transition-all">
                  ...
                  <p className="text-sm text-gray-600">
                    Acceso a indicadores de desarrollo, economía y medio
                    ambiente de más de 200 países con series temporales
                    históricas.
                  </p>
                </div>
                <div className="p-6 rounded-2xl border border-cyan-100 bg-white hover:shadow-md transition-all">
                  <h4 className="text-lg font-bold text-cyan-800 mb-2">
                    WHO GHO
                  </h4>
                  <p className="text-sm text-gray-600">
                    Observatorio Global de Salud de la OMS. Crucial para
                    estudios de salud pública y su relación con factores
                    ambientales.
                  </p>
                </div>
              </div>
            ...
            <Section title="Métodos Estadísticos" icon="📐">
              <p className="text-gray-700 mb-8">
                ECOstats calcula simultáneamente tres tipos de coeficientes para
                darte una visión completa de tus datos:
              </p>
            ...
            <Section title="Prepara tus Datos" icon="📊">
              <div className="bg-slate-900 rounded-3xl p-8 text-white mb-8">
                ...
                <p className="mb-6 opacity-90">
                  Descarga este archivo CSV preformateado para probar la
                  herramienta y entender la estructura requerida.
                </p>
                <a
              ...
              <div className="flex flex-col md:flex-row gap-8 items-center">
                <div className="flex-1">
                  <p className="text-gray-700 leading-relaxed mb-6">
                    Fomentamos la <strong>Ciencia Abierta</strong>. Los
                    algoritmos estadísticos que impulsan ECOstats son
                    transparentes y auditables. Si eres desarrollador o
                    investigador, te invitamos a revisar, mejorar o bifurcar
                    nuestro código.
                  </p>
                  <a
